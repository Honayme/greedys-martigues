...
<v-toolbar
    @filter-applied='setFilters("toolbar", $event)'
    @open-filter-drawer="isDrawerActive.filter = true"
></v-toolbar>
...
@pushOnce('scripts')
    ...
    >
        <div>
            <!-- Desktop Toolbar -->
            <div class="flex justify-between py-4 max-md:hidden">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <button
                        ...
                        class="inline-flex items-center justify-center h-[54px] px-4 py-2 text-sm font-medium transition-colors bg-white border border-zinc-200 rounded-lg hover:bg-neutral-100 active:bg-white focus:bg-white focus:outline-none focus:ring-2 focus:ring-neutral-200/60 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none"
                    >
                        <span class="mr-2">Filtrer</span>
                        <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="1.5"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path fill-rule="evenodd" clip-rule="evenodd" d="M15 10.5A3.502 3.502 0 0 0 18.355 8H21a1 1 0 1 0 0-2h-2.645a3.502 3.502 0 0 0-6.71 0H3a1 1 0 0 0 0 2h8.645A3.502 3.502 0 0 0 15 10.5zM3 16a1 1 0 1 0 0 2h2.145a3.502 3.502 0 0 0 6.71 0H21a1 1 0 1 0 0-2h-9.145a3.502 3.502 0 0 0-6.71 0H3z" fill="#000000"></path></g></svg>
                    </button>
                </div>
