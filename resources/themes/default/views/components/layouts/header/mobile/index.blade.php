                    ...
                    <div class="mb-4 grid grid-cols-[auto_1fr] items-center gap-4 rounded-xl border border-zinc-200 p-2.5 max-md:mt-4">
                        ...
                        @auth('customer')
                            <div class="flex flex-col justify-between gap-2.5 max-md:gap-0">
                                <p class="font-mediums break-words text-2xl max-md:text-xl">Hello! {{ auth()->user()?->first_name }}</p>
                ...
                <ul class="flex items-center space-x-6 text-base font-medium text-gray-700" style="position:relative;z-index:1;flex-shrink:0;">
                    <li class="relative mx-4">
                        <a href="https://www.facebook.com/stephane.moustachatte.5" class="hover:opacity-70 transition">
                            <img src="{{ asset('storage/social-icons/facebook.svg') }}" alt="Facebook" style="width:20px;height:20px;display:block;">
                        </a>
                    </li>
                    <li class="relative mx-4">
                        <a href="https://www.instagram.com/greedyscreation_/?hl=fr" class="hover:opacity-70 transition">
                            <img src="{{ asset('storage/social-icons/instagram.svg') }}" alt="Instagram" style="width:20px;height:20px;display:block;">
                        </a>
                    </li>
                    <li class="relative mx-4">
                        <a href="https://www.tiktok.com/@kmillewardrobe" class="hover:opacity-70 transition">
                            <img src="{{ asset('storage/social-icons/tiktok.svg') }}" alt="TikTok" style="width:20px;height:20px;display:block;">
                        </a>
                    </li>
                </ul>
