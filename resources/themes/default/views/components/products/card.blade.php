...
@pushOnce('scripts')
    ...
    >
        ...
        <div
            ...
            v-if="mode != 'list'"
        >
            <div class="relative max-h-[360px] max-w-[350px] overflow-hidden max-md:max-h-60 max-md:max-w-full max-md:rounded-lg max-sm:max-h-[200px] max-sm:max-w-full">
